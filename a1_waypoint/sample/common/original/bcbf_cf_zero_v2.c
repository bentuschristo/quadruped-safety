...
static double cbf_log_qp_time_sec = 0.0;      // closed-form KKT update time only [s]
static double cbf_log_filter_time_sec = 0.0;  // full safety-filter call wall time [s]
...
{
    double cbf_filter_t0 = cbf_now_sec();
