...
for s = 1:numel(scenarios)
    ...
    if has_full_time
        ...
        if full_filter_zoom_enabled
            add_full_filter_time_zoom_inset_sim(D, s, methods, colors, linestyles, ...
...
function add_full_filter_time_zoom_inset_sim(D, scenario_idx, methods, colors, linestyles, Linewidth, inset_position, zoom_xlim, zoom_ylim, zoom_title)
    ax = axes('Position', inset_position); %#ok<LAXES>
